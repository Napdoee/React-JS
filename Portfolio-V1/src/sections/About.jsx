const About = () => {
 return (
  <section id="about" className="relative pt-32 pb-24 lg:h-screen grid items-center bg-page-100 dark:bg-dark">
    <div className="container py-10">
        <div className="flex flex-wrap justify-center">
            <div className="w-full lg:w-1/2 px-4 mb-10">
                <h4 className="heading-title">Tentang Saya</h4>
                <h3 className="title w-fit rounded-lg px-2 border-x-4 border-primary">Pengembang Web</h3>
                <p className="text text-justify">Seorang pengembang web pemula yang tertarik untuk membangun karir
                    di industri pengembangan web, memiliki rasa penasaran terhadap teknologi pemrograman web
                    terbaru.</p>
                <div className="flex items-center gap-5 mb-10">
                    <a href="https://github.com/Napdoee" target="_blank"
                        className="w-9 h-9 rounded-full flex justify-center items-center text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                        <svg className="fill-current" width="30" role="img" viewBox="0 0 24 24"
                    ...
                    <a href="#" target="_blank"
                        className="w-9 h-9 rounded flex justify-center items-center text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                        <svg className="fill-current" width="30" role="img" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full px-4 lg:w-1/2 lg:pt-8">
                <h3 className="title w-fit rounded-lg px-2 border-x-4 border-primary">Keahlian</h3>
                <p className="text">Seiring berjalannya waktu beberapa keahlian dalam pemrograman web yang
                    telah saya gunakan adalah sebagai berikut: </p>
                <div className="flex flex-wrap mb-5">
                    <div className="w-full lg:w-1/2 mb-5">
                        <ul className="list-disc text-white ml-6">
                            <li className="mb-3">
                                <h4 className="font-semibold text-md text-white mb-3">Front-end</h4>
                                <ul className="flex flex-wrap gap-5 items-center mb-4">
                                    <li className="text-slate-300 hover:text-code-11">
                                        <div className="flex items-center gap-2">
                                            <svg width="25" className="fill-current" role="img" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <title>HTML5</title>
                                                <path
                                    ...
                                    <li className="text-slate-300 hover:text-code-12">
                                        <div className="flex items-center gap-2">
                                            <svg width="25" className="fill-current" role="img" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <title>CSS3</title>
                                    ...
                                    <li className="text-slate-300 hover:text-code-13">
                                        <div className="flex items-center gap-2">
                                            <svg width="25" className="fill-current" role="img" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li className="text-slate-300 hover:text-code-21">
                                        <div className="flex items-center gap-2">
                                            <svg width="25" className="fill-current" role="img" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li className="text-slate-300 hover:text-code-22">
                                        <div className="flex items-center gap-2">
                                            <svg width="25" className="fill-current" role="img" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="w-full lg:w-1/2 mb-5">
                        <ul className="list-disc text-white ml-6">
                            <li className="mb-3">
                                <h4 className="font-semibold text-md text-white mb-3">Back-end</h4>
                                <ul className="flex flex-wrap gap-5 items-center mb-4">
                                    <li className="text-slate-300 hover:text-code-31">
                                        <div className="flex items-center gap-2">
                                            <svg width="25" className="fill-current" role="img" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <title>PHP</title>
                                    ...
                                    <li className="text-slate-300 hover:text-code-32">
                                        <div className="flex items-center gap-2">
                                            <svg width="25" className="fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <title>Node.js</title>
                                    ...
                                    <li className="text-slate-300 hover:text-code-33">
                                        <div className="flex items-center gap-2">
                                            <svg width="25" className="fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <title>MySQL</title>
                                    ...
                                    <li className="text-slate-300 hover:text-code-34">
                                        <div className="flex items-center gap-2">
                                            <svg width="25" className="fill-current" role="img" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li className="text-slate-300 hover:text-code-41">
                                        <div className="flex items-center gap-2">
